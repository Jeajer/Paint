...
namespace Paint.Methods
{
    public class Method
    {
        ...
        public static Ellipse GetEllipse(Vector3 center, Vector3 firstPoint, Vector3 secondPoint)
        {
            ...
            double minjor = center.DistanceFrom(secondPoint);
            double angle = LineAngle(center, firstPoint);
            Entities.Ellipse ellipse = new Entities.Ellipse(center, major, minjor);
        ...
        #region Intersection between two lines
        ...
        #endregion Intersection between two lines

        #region Intersection between line and ellipse
        ...
        #endregion Intersection between line and ellipse

        #region Intersection between line and circle
        ...
        #endregion Intersection between line and circle

        #region Intersection between line and arc
        ...
        #endregion Intersection between line and arc

        #region check the point is on the arc
        ...
        #endregion check the point is on the arc
        ...
        #endregion Distance point to line

        #region Distance point to ellipse
        ...
        #endregion Distance point to ellipse

        #region Distance point to circle
        ...
        #endregion Distance point to circle

        #region Distance point to arc
        ...
        #endregion Distance point to arc

        #region Distance point to lwpolyline
        ...
        #endregion Distance point to lwpolyline

        #region Get segment index
        ...
        #endregion Get segment index

        #region Check if point is in polygon
        ...
        #endregion Check if point is in polygon

        #region Modify1 selection
        public static void Modify1Selection(int modifyIndex, List<EntityObject> entities, Vector3 fromPoint, Vector3 toPoint, bool flag = false)
        {
            for (int i = 0; i < entities.Count; i++)
            {
